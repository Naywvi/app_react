...
module.exports = {
    ...
    run: async (req, res) => {
        try {
            sous_face_photo["photo_vide_sanitaire"] = req.body['photo_vide_sanitaire'] !== undefined ? req.body['photo_vide_sanitaire'] : null;
            sous_face_photo["photo_sous_face"] = req.body['photo_sous_face'] !== undefined ? req.body['photo_sous_face'] : null;
            sous_face_photo["photo_cave"] = req.body['photo_cave'] !== undefined ? req.body['photo_cave'] : null;
            ...
            sous_face['sous_face'] = {
                ...
                'volume': calcule.volume(req.body['hauteur_garage'], req.body['largeur_garage'], req.body['longueur']),
